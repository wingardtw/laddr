...
class Home extends Component {
  render() {
    return (
      <Page title="Home" subtitle="this is the home dashboard">
        <PageContent>
          ...
          <div className="home__activity">
            ...
            <div className="home__activity__area">this is stuff</div>
          </div>
          ...
          <div className="home__cta">
            <p className="home__cta__copy">Need a new duo partner?</p>
